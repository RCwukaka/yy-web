...
$(document).ready(function(){
	...
	topbar.setAttribute("style", "display:none;position:fixed;left:96%;top:550px;width:40px;height:40px;background:url('http://7xobyw.com1.z0.glb.clouddn.com/iconfont-fanhuidingbu.png') no-repeat;font-size:15px;text-align:center;");
	...
	topbar.onmouseout=function(){
		this.innerHTML="";
		$('#topbar').css("background","url('http://7xobyw.com1.z0.glb.clouddn.com/iconfont-fanhuidingbu.png')no-repeat");
	};
});
$(function() {  
