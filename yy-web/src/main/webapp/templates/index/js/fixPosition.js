...
$.extend({
	...
	qryOrderCallBack:function(responseMsg){
		...
		for(var i=0;i<length;i++) {
			result += "<li><div class='newsImage'><img src='http://7xobyw.com1.z0.glb.clouddn.com/test.png'></div><div class='newsFont'><a href="+datalist[i].newsURL+" class='newsname'>";
