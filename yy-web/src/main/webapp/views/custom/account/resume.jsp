     ...
     <div class="row">
		<div class="col-md-12">
			<div class="jumbotron">
				...
				<p>
					<a class="btn btn-primary btn-lg" href="" onclick="window.parent.location.href='${pageContext.request.contextPath}/job/index/${token}'" role="button"
						disabled="disabled">创建简历</a>
				</p>
			</div>
		</div>
	</div>
