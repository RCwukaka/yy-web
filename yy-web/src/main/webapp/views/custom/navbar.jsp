	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav" id="header">
				<li><a href="${pageContext.request.contextPath}/index">资讯<span class="sr-only">(current)</span></a></li>
			...
			<c:choose>
				...
				<ul class="nav navbar-nav navbar-right hidden-sm">
					<li><a href="${pageContext.request.contextPath}/login">登陆/注册</a></li>
				</ul>
				</c:when>
				...
				<ul class="nav navbar-nav navbar-right hidden-sm">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li class="hidden-sm hidden-md"><a href='${pageContext.request.contextPath}/account/${session.token}/base' data-click="info">基本信息</a></li>
							<li role="separator" class="divider"></li>
							<li><a href='${pageContext.request.contextPath}/account/${session.token}/resume' data-click="resume" class="req">我的简历</a></li>
							<li role="separator" class="divider" ></li>
							<li><a href='${pageContext.request.contextPath}/account/${session.token}/article' data-click="article" class="req">我的文章</a></li>
							<li role="separator" class="divider"></li>
							<li><a href='${pageContext.request.contextPath}/account/${session.token}/company' data-click="company" class="req">关注的公司</a></li>
							<li role="separator" class="divider"></li>
							<li><a href='${pageContext.request.contextPath}/account/${token}/collects' data-click="collects" class="req">收藏的文章</a></li>
							<li role="separator" class="divider"></li>
							<li><a href='${pageContext.request.contextPath}/loginOut?csrfToken=${object.token}' data-click="loginout" id="req">退出</a></li>
						</ul></li>
				</ul>
			</c:otherwise>
			</c:choose>
